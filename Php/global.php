...
$summ = 50;
$bread = 50;
$fun = fn($summ, $bread) => $summ == $bread ?
["str" => 'Вы можете купить хлеб, без сдачи', "result" => null] :
($summ > $bread ? ["str" => 'Вы можете купить хлеб, ваша сдача:', "result" => $summ - $bread] :
["str" => 'Вам не хватает: ', "result" => $bread - $summ]); 
$result = $fun($summ, $bread); ?>
